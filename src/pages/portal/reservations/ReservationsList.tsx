...
/**
 * ReservationsListSection — body-only (no PortalLayout, no PageHeader).
        ...
        {isLoading ? (
          ...
          <>
              ...
              <tbody>
                {data!.rows.map((r: any) => (
                  <tr key={r.id} className="border-t border-border-subtle hover:bg-background">
                    ...
                    <td className="px-[18px] py-[14px]">
                      {r.owners ? (
                        <Link to={`/owners/${r.primary_owner_id}`} className="text-foreground hover:text-primary">
                    ...
                    <td className="px-[18px] py-[14px]"><ReservationStatusBadge status={r.status} /></td>
                    <td className="px-[18px] py-[14px]">
            ...
            <div className="flex items-center justify-between border-t border-border-subtle px-4 py-3 text-xs text-text-secondary">
              <span>{data!.count} reservation{data!.count === 1 ? "" : "s"}</span>
